...
const RoomDataRow = ({ room,handleDelete, refetch }) => {
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <button onClick={()=>setEditModalOpen(true)} className='relative cursor-pointer inline-block px-3 py-1 font-semibold text-green-900 leading-tight'>
          <span
            aria-hidden='true'
        ...
        {/* Update Modal */}
        <UpdateRoomModal isOpen={isEditModalOpen} setIsEditModalOpen={setEditModalOpen}
        room={room}
        refetch={refetch}
        />
      </td>
